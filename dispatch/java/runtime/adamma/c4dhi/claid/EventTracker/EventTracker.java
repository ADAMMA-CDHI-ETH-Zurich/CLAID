...
public class EventTracker
{
    ...
    {
        String storageFolderPath = CLAID.getCommonDataPath() + "/Data/Logs";
        ...
        // Format for filenames: moduleId_dd.MM.yy_events.txt
        DateTimeFormatter fileFormatter = DateTimeFormatter.ofPattern("dd.MM.yy");
        String dateString = time.format(fileFormatter);
        
        Path path = Paths.get(storageFolderPath, moduleId + "_" + dateString + "_events.txt");
