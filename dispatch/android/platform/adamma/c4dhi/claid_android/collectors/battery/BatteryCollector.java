...
public class BatteryCollector extends Module
{
    ...
    public static void annotateModule(ModuleAnnotator annotator)
    {
        ...
        + "The BatteryCollector features two modes: Peridoically and OnChange.\n"
        ...
        annotator.describeProperty("monitoringmMode", "String: Allows to specify how the battery information shall be monitored. Two options are available: \n"
